...
const categories = ['all', 'Development', 'Design', 'Graphics', 'React', 'JavaScript', 'UI/UX'];
...
const Portfolio = () => {
  ...
  return (
    // BACKGROUND HERO
    <div className="min-h-screen bg-gradient-to-br from-green-600 via-[#0e7490] to-indigo-700">
      {/* Sticky Navigation */}
      <nav className="fixed top-0 w-full bg-white/40 backdrop-blur-sm border-b border-gray-200 z-50 shadow-sm">
      ...
      {/* Hero Section */}
      <section id="home" className="pt-44 pb-44 px-6 bg-gradient-to-b from-transparent to-white/60">
        <div className="max-w-4xl mx-auto text-center">
          <div className="mb-6 ">
            <div className="w-24 h-24 mx-auto mb-6 rounded-full bg-gradient-to-br from-[#0e7490] to-[#bbf7d0] flex items-center justify-center text-white text-2xl font-bold shadow-lg">
              IC
            </div>
          </div>
          ...
          <p className="text-base text-gray-900 mb-12 max-w-2xl mx-auto leading-relaxed">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <button
              ...
              className="px-8 py-3 bg-gray-900 text-white text-sm font-medium hover:bg-gray-800 transition-colors duration-200"
            >
              View Work
            </button>
            <button
              onClick={() => scrollToSection('contact')}
              className="px-8 py-3 border border-gray-300 text-gray-900 text-sm font-medium hover:bg-gray-50 transition-colors duration-200"
            >
              Contact
            </button>
          </div>
      ...
      {/* Projects Section */}
      <section id="projects" className="py-16 px-6 bg-gradient-to-b from-gray-50 to-slate-100">
          ...
          {viewMode === 'grid' && (
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
              {filteredProjects.map((project, index) => (
                <Link to={`/project/${project.slug}`} key={project.slug} className="bg-white/90 backdrop-blur-sm group hover:shadow-xl transition-all duration-300 border border-gray-100">
      ...
      {/* Contact Section */}
      <section id="contact" className="py-16 px-6 bg-gradient-to-b from-white to-slate-50">
        <div className="max-w-4xl mx-auto text-center">
